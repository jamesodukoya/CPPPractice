...
int main() {
    ...
    std::copy(my_vector.begin(), my_vector.end(), std::inserter(my_result1, std::next(my_result1.begin())));
    ...
    std::copy(my_vector.begin(), my_vector.end(), std::back_inserter(my_result2));
